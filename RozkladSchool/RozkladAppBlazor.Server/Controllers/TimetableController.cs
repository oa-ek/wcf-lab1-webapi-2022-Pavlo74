...
namespace RozkladAppBlazor.Server.Controllers
{
    ...
    public class TimetableController : ControllerBase
    {
        ...
        public TimetableController(TimetableRepository timetableRepository, /*CabinetRepository cabinetRepository,*/ ILogger<TimetableController> logger)
        {
